...
/******/ 	__webpack_require__.p = "/codemirror/dist/";
/******/
/******/
/******/ 	// Load entry module and return exports
/******/ 	return __webpack_require__(__webpack_require__.s = "./codemirror.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var y_codemirror__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! y-codemirror */ "./node_modules/y-codemirror/src/y-codemirror.js");
...
/*!***********************************!*\
  !*** ./node_modules/lib0/diff.js ***!
  \***********************************/
/*! exports provided: simpleDiffString, simpleDiff, simpleDiffArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "simpleDiffString", function() { return simpleDiffString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "simpleDiff", function() { return simpleDiff; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "simpleDiffArray", function() { return simpleDiffArray; });
...
/*!*******************************************************!*\
  !*** ./node_modules/y-codemirror/src/y-codemirror.js ***!
  \*******************************************************/
/*! exports provided: cmOrigin, CodemirrorBinding, CodeMirrorBinding */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cmOrigin", function() { return cmOrigin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CodemirrorBinding", function() { return CodemirrorBinding; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CodeMirrorBinding", function() { return CodeMirrorBinding; });
/* harmony import */ var lib0_mutex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lib0/mutex.js */ "./node_modules/lib0/mutex.js");
...
/* harmony import */ var lib0_eventloop_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lib0/eventloop.js */ "./node_modules/lib0/eventloop.js");
/* harmony import */ var lib0_diff_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lib0/diff.js */ "./node_modules/lib0/diff.js");
/* harmony import */ var codemirror__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! codemirror */ "./node_modules/codemirror/lib/codemirror.js");
  ...
  binding._mux(() => {
    binding.doc.transact(() => {
      if (changes.length > 1) {
        ...
        const d = lib0_diff_js__WEBPACK_IMPORTED_MODULE_5__["simpleDiffString"](binding.type.toString(), binding.cmDoc.getValue())
...
const updateRemoteSelection = (y, cm, type, cursors, clientId, awareness) => {
  ...
  const anchor = yjs__WEBPACK_IMPORTED_MODULE_2__["createAbsolutePositionFromRelativePosition"](JSON.parse(cursor.anchor), y)
  const head = yjs__WEBPACK_IMPORTED_MODULE_2__["createAbsolutePositionFromRelativePosition"](JSON.parse(cursor.head), y)
  if (anchor !== null && head !== null && anchor.type === type && head.type === type) {
    ...
    if (m && lib0_function_js__WEBPACK_IMPORTED_MODULE_3__["equalityFlat"](aw.cursor.anchor, m.awCursor.anchor) && lib0_function_js__WEBPACK_IMPORTED_MODULE_3__["equalityFlat"](aw.cursor.head, m.awCursor.head)) {
    ...
    if (head.index !== anchor.index) {
      if (from.line !== to.line && from.ch !== 0) {
        ...
        sel.push(cm.markText(from, new codemirror__WEBPACK_IMPORTED_MODULE_6___default.a.Pos(from.line + 1, 0), { css: `background-color: ${user.color}70;`, inclusiveRight: false, inclusiveLeft: false }))
        from = new codemirror__WEBPACK_IMPORTED_MODULE_6___default.a.Pos(from.line + 1, 0)
      }
      while (from.line !== to.line) {
        ...
        sel.push(cm.setBookmark(new codemirror__WEBPACK_IMPORTED_MODULE_6___default.a.Pos(from.line, 0), { widget: createEmptyLinePlaceholder(user.color) }))
        from = new codemirror__WEBPACK_IMPORTED_MODULE_6___default.a.Pos(from.line + 1, 0)
      }
...
const codemirrorCursorActivity = (y, cm, type, awareness) => {
  ...
  const newAnchor = yjs__WEBPACK_IMPORTED_MODULE_2__["createRelativePositionFromTypeIndex"](type, cm.indexFromPos(cm.getCursor('anchor')))
  const newHead = yjs__WEBPACK_IMPORTED_MODULE_2__["createRelativePositionFromTypeIndex"](type, cm.indexFromPos(cm.getCursor('head')))
  let currentAnchor = null
  let currentHead = null
  if (aw.cursor != null) {
    currentAnchor = yjs__WEBPACK_IMPORTED_MODULE_2__["createRelativePositionFromJSON"](JSON.parse(aw.cursor.anchor))
    currentHead = yjs__WEBPACK_IMPORTED_MODULE_2__["createRelativePositionFromJSON"](JSON.parse(aw.cursor.head))
  }
  if (aw.cursor == null || !yjs__WEBPACK_IMPORTED_MODULE_2__["compareRelativePositions"](currentAnchor, newAnchor) || !yjs__WEBPACK_IMPORTED_MODULE_2__["compareRelativePositions"](currentHead, newHead)) {
...
class CodemirrorBinding {
  ...
  constructor (textType, codeMirror, awareness) {
    ...
    this._mux = Object(lib0_mutex_js__WEBPACK_IMPORTED_MODULE_0__["createMutex"])()
    // set initial value
    ...
    this._debounceCursorEvent = lib0_eventloop_js__WEBPACK_IMPORTED_MODULE_4__["createDebouncer"](10)
